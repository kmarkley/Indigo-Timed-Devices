...
The most common use is inferring activity in a room or area by tracking motion sensors.  You may wish to have more than one motion sensor activate before assuming a room is in use, and/or extend the timeout when one or more motion sensors are re-activated.
...
Not sure there is an obvious use for this one, but I do find it useful in a few situations, especially when I don't want on/off triggers to fire too close together.

## Plugin configuration

* **Show Timer**  
Check have Indigo display a countdown timer for each device when appropriate.  Uncheck to reduce the communication overhead between Indigo and the plugin.
...
* **ON Persist Cycles** and **ON Persist Unites**  
...
* **ON Lockout Cycles** and **ON Lockout Unites**  
...
Force the plugin device to become off.  For **Activity Timer** devices, **reset** and **expired** states will be/remain false.
